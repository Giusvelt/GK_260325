      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-xl border-b border-surface-low/30 h-16 sm:h-20 lg:h-24 px-6 sm:px-10 lg:px-16 flex items-center justify-between shadow-sm">
        <div className="flex items-center gap-4 lg:gap-6">
          ...
          <div className="flex flex-col">
            <h1 className="font-manrope font-extrabold text-xl lg:text-2xl text-on-surface tracking-tight leading-none mb-1">
              GeoKanban <span className="text-[10px] font-bold text-primary/40 align-top ml-1">v3.11</span>
            </h1>
            <p className="text-[10px] lg:text-xs font-black text-primary uppercase tracking-[0.2em] opacity-80 leading-none">
              Breakwater Fleet Tracker — Genova
            </p>
          </div>
        </div>
